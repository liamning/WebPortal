<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TrainingReport.aspx.cs" Inherits="TrainingReport" %>
...
<body>
    ...
    <div id="content">
        ...
        <div id="navigationBar">
            <p>Staff Portal > Training Report</p> 
        </div>
        <div id="center" class="font12pt">
            <table style="min-width: 80%;">
                <tr>
                    <td colspan="2">
                        <h4 class="bar">Training Report</h4>         
                    </td> 
                </tr>  
